			...
			{notifications.map((request) => (
				<div key={request.id} className="flex flex-col gap-2 rounded-xl border-2 px-4 py-3">
					...
					<div className="flex items-center justify-between">
						...
						<p className="ml-5 text-sm whitespace-nowrap opacity-50">{request.createdAt}</p>
					</div>
	...
	return (
		<div>
			...
			{recentNotifications.length > 0 && (
				<div>
					<h1 className="mb-2 text-lg font-semibold">Recent</h1>
			...
			{daysNotifications.length > 0 && (
				<div>
					<h1 className="mb-2 text-lg font-semibold">This Week</h1>
			...
			{weeksNotifications.length > 0 && (
				<div>
					<h1 className="mb-2 text-lg font-semibold">Past Weeks</h1>
			...
			{monthsNotifications.length > 0 && (
				<div>
					<h1 className="mb-2 text-lg font-semibold">Past Months</h1>
